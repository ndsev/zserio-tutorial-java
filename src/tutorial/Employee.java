/**
 * Automatically generated by Zserio Java extension version 2.4.0.
...
public class Employee implements zserio.runtime.io.InitializeOffsetsWriter, zserio.runtime.SizeOf
{
    ...
    public int bitSizeOf(zserio.runtime.array.PackingContextNode contextNode, long bitPosition)
    {
        ...
        endBitPosition += contextNode.getChildren().get(0).getContext().bitSizeOf(
                new zserio.runtime.array.ArrayTraits.BitFieldShortArrayTraits((int)(8)), endBitPosition,
                new zserio.runtime.array.ArrayElement.ShortArrayElement(age_));
        endBitPosition += zserio.runtime.BitSizeOfCalculator.getBitSizeOfString(name_);
        endBitPosition += contextNode.getChildren().get(2).getContext().bitSizeOf(
                new zserio.runtime.array.ArrayTraits.BitFieldIntArrayTraits((int)(16)), endBitPosition,
                new zserio.runtime.array.ArrayElement.IntArrayElement(salary_));
        endBitPosition += 1;
        if (bonus_ != null)
        {
    ...
    public void setSkills(tutorial.Experience[] skills_)
    {
        ...
        else
        {
            this.skills_ = new zserio.runtime.array.Array(
                    ...
                    new zserio.runtime.array.ArrayTraits.WriteObjectArrayTraits<tutorial.Experience>(new ElementFactory_skills()),
    ...
    public int hashCode()
    {
        ...
        result = zserio.runtime.Util.HASH_PRIME_NUMBER * result + age_;
        result = zserio.runtime.Util.HASH_PRIME_NUMBER * result +
                ((name_ == null) ? 0 : name_.hashCode());
        result = zserio.runtime.Util.HASH_PRIME_NUMBER * result + salary_;
        result = zserio.runtime.Util.HASH_PRIME_NUMBER * result +
                ((bonus_ == null) ? 0 : bonus_.hashCode());
        result = zserio.runtime.Util.HASH_PRIME_NUMBER * result +
                ((role_ == null) ? 0 : role_.hashCode());
        if (getRole() == tutorial.Role.DEVELOPER)
            result = zserio.runtime.Util.HASH_PRIME_NUMBER * result +
                    ((skills_ == null) ? 0 : skills_.hashCode());
