...
public class Experience implements zserio.runtime.io.InitializeOffsetsWriter, zserio.runtime.SizeOf
{
    ...
    public int bitSizeOf(zserio.runtime.array.PackingContextNode contextNode, long bitPosition)
    {
        ...
        endBitPosition += contextNode.getChildren().get(0).getContext().bitSizeOf(
                new zserio.runtime.array.ArrayTraits.BitFieldByteArrayTraits((int)(6)), endBitPosition,
                new zserio.runtime.array.ArrayElement.ByteArrayElement(yearsOfExperience_));
    ...
    public int hashCode()
    {
        ...
        result = zserio.runtime.Util.HASH_PRIME_NUMBER * result + yearsOfExperience_;
        result = zserio.runtime.Util.HASH_PRIME_NUMBER * result +
                ((programmingLanguage_ == null) ? 0 : programmingLanguage_.hashCode());
            ...
            throws java.io.IOException
    {
        ...
        programmingLanguage_.write(out, false);
    }
