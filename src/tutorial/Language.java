...
public enum Language implements zserio.runtime.io.InitializeOffsetsWriter,
        zserio.runtime.SizeOf, zserio.runtime.ZserioEnum
{
    ...
    {
        contextNode.getContext().init(new zserio.runtime.array.ArrayElement.ByteArrayElement(value));
    }
    ...
    public int bitSizeOf(zserio.runtime.array.PackingContextNode contextNode, long bitPosition)
    {
        return contextNode.getContext().bitSizeOf(
                new zserio.runtime.array.ArrayTraits.BitFieldByteArrayTraits(2), bitPosition,
